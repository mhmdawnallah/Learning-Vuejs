...
- **Don't Repeat Yourself (DRY)**: That appers in a great way in Vue js components && Mixins as appeared in Options API in Vue Js version 2 or the custom composition functions when dealing with Composition API as in Vue js version 3.
